...
class VideoManager(models.Manager):
    ...
    def get_queryset(self):
        ...
        return super(VideoManager, self).get_queryset().filter(type='channel')
...
class Channel(models.Model):
    ...
    channelNumber = models.IntegerField(max_length=9, null=True, blank=True,
    ...
    class Meta:
        ordering = ['channelNumber']
        db_table = "channels"
        verbose_name_plural = "channels"


class QualityControlReviewChannel(Channel):
